...
public class ShowMoveable extends JPanel {
	...
	public static void main (String [] args){
		...
		Circle ci = new Circle(new Vertex(10,10),new Vertex(5,5),50);
		Ellipse el = new Ellipse(new Vertex(10,10),new Vertex(5,5),50,30);
		Star s = new Star(new Vertex(10,10),new Vertex(5,5),50,80,5);
